...
function listenForDownloadHeaders (ses) {
  ses.webRequest.onHeadersReceived(function (details, callback) {
    ...
    */
    if (details.webContents && (details.webContents.getURL().startsWith('rninedesktop://app/pages/pdfViewer') || details.webContents.getURL().startsWith('rninedesktop://app/reader/') || details.webContents.getURL() === 'rninedesktop://app/index.html')) {
      ...
      callback({
        responseHeaders: {
          ...filteredHeaders,
          'Access-Control-Allow-Origin': 'rninedesktop://app',
